...
ActiveRecord::Schema.define(version: 2019_03_05_005633) do
  ...
  create_table "labels_tasks", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
